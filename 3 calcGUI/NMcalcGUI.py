...
class Calculator(Frame):
    ...
    def create_widgets(self):
        ...
        self.one_bttn = Button(self, text="Norman", width=9, height=3, command=lambda: self.add_chr("McCord"))
...
root = Tk()
root.geometry()
root.title("NM's GUI Calculator")
app = Calculator(root)
root.mainloop()